...
function Header() {
  return (
    <header className="px-4 sm:px-8 md:px-16 py-4 sm:py-8 md:py-10 flex justify-center items-center w-full">
      ...
      <div className=" py-4 sm:px-8 md:px-16 flex justify-between items-center rounded-full w-full border border-[#000000]">
        ...
        <button className="bg-[#0D0D0D] rounded-[6px] py-3.5 px-6 transition-class hover:opacity-80">Join Us</button>
      </div>
    </header>
  );
}
