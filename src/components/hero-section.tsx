...
function Hero() {
  ...
  return (
    <section className="flex justify-between items-center gap-8 lg:gap-4 w-full h-screen lg:flex-nowrap flex-wrap pb-8 pt-36 text-black px-4 sm:px-8 md:px-16 lg:px-20 xl:px-24">
